...
void FAnimNode_SoftBone::Initialize_AnyThread(const FAnimationInitializeContext& Context)
{
...
void FAnimNode_SoftBone::CacheBones_AnyThread(const FAnimationCacheBonesContext& Context)
{
...
{
	return (TipBone.IsValidToEvaluate(BoneContainer)
...
void FAnimNode_SoftBone::EvaluateSkeletalControl_AnyThread(FComponentSpacePoseContext& Output, TArray<FBoneTransform>& OutBoneTransforms)
{
