...
#include "AnimGraphNode_SoftBone.h"
...
void UAnimGraphNode_SoftBone::CopyNodeDataToPreviewNode(FAnimNode_Base* InPreviewNode)
//void UAnimGraphNode_SoftBone::CopyNodeDataFrom2(const FAnimNode_Base* NewAnimNode)
{
	const FAnimNode_SoftBone* SoftBoneNode = static_cast<const FAnimNode_SoftBone*>(InPreviewNode);
